...
"dauntless", "eager", "earnest", "easy", "elated", "eccentric", "fair", "fabulous", "faithful", "famous", "fanciful", "factual", "gigantic", "glad", "gloomy", "glamorous", "guiltless", "gentle", 
"hilarious", "happy", "hungry", "hysterical", "hollow", "introverted", "iconical", "icky", "illogical", "impassioned", "implicit", "ingenious", "jovial", "jazzy", "jestful", "jumbled", "justified", 
"kindled", "kindred", "keen", "knowledgeable", "kingly", "laborious", "lamentable", "lacking", "lovely", "magnetic", "masterful", "magnanimous", "merry", "magnificent", "narrow", "neat", 
...
const nounArray = ["apple", "aardvark", "avocado", "avalanche", "boat", "board", "billion", "bluff", "brawn", "code", "club", "coffee", "card", "capital", "captain", "disaster", "dawn", "dancer", 
"decade", "diamond", "eagle", "elegance", "emerald", "explosion", "event", "fan", "face", "few", "figure", "frame", "function", "goal", "gamble", "goat", "gold", "guard", "hand", "home", "heart", 
...
"laser", "logic", "loop", "machine", "manager", "method", "million", "museum", "nacho", "nickel", "nectar", "nominee", "outcast", "opal", "ooze", "olive", "object", "plant", "platform", "point",
